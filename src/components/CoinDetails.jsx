 ...
 return(
    <Container  maxWidth={"container.xl"}>
      
      {
        ...
        loading ? <Loader/> :(
            <>
                 <Box width={"full"} borderWidth={1} h={"120vh"} justifyContent={"center"} >
               ...
               <VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
                ...
                <Stat>
                    ...
                    <StatHelpText>
                        <StatArrow type={coin.market_data.price_change_24h_in_currency[currency] > 0 ? "increase" : "decrease"}  /> {coin.market_data.price_change_24h_in_currency[currency]}
                        <StatArrow type={coin.market_data.price_change_percentage_24h_in_currency[currency] > 0 ? "increase" : "decrease"} />{coin.market_data.price_change_percentage_24h_in_currency[currency]}
                    </StatHelpText>
                </Stat>
